...
echo -e " "
echo -e " "
echo -e "\033[0;37m === UPLOAD SCRIPT ST PUSAT BLITAR  == "
echo -e " "
echo -e "\033[1;36m - Script Ini Di Buat Gratis "
echo -e " - Jangan Sampai Di Perjual Belikan "
echo -e " - Untuk Infonya Silahkan Hubungi Admin "
echo -e " "
...
<code>â ï¸ AUTOSCRIPT ST-PUSATâ ï¸</code>
<code>ââââââââââââââââââââ</code>
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version 1.8.23
    ...
    wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/amonnoris1/websocks/main/cok/fire/haproxy.cfg" >/dev/null 2>&1
    wget -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/amonnoris1/websocks/main/cok/fire/xray.conf" >/dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/amonnoris1/websocks/main/media/limmit && chmod +x limmit && ./limmit
wget -q https://raw.githubusercontent.com/amonnoris1/websocks/main/media/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh
wget -q https://raw.githubusercontent.com/amonnoris1/websocks/main/slowdns/noobzvpns.zip
unzip noobzvpns.zip
bash install.sh
rm -rf noobzvpns
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/amonnoris1/websocks/main/media/issue.net"
...
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "https://raw.githubusercontent.com/amonnoris1/websocks/main/bokep/dora/ws" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/amonnoris1/websocks/main/bokep/dora/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/amonnoris1/websocks/main/bokep/dora/ws.service" >/dev/null 2>&1
