...
<code>â ï¸ AUTOSCRIPT HAPROXY SIMPLE â ï¸</code>
<code>ââââââââââââââââââââ</code>
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    wget https://raw.githubusercontent.com/amonnoris1/websocks/main/media/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh
...
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "https://raw.githubusercontent.com/amonnoris1/websocks/main/media/ws" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/amonnoris1/websocks/main/media/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/amonnoris1/websocks/main/media/ws.service" >/dev/null 2>&1
